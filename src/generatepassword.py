import secrets 
import string
from password_strength import SPECIAL_CHARS, calculate_entropy, find_sequential_chars 
...
class PasswordGenerator:
    ...
    def generate_password(self) -> str:
        ...
        while True:
            ...
            if meets_requirements and (calculate_entropy(password) * find_sequential_chars(password)) >= self.MIN_ENTROPY:
                return password
